...
class Menu(QtWidgets.QMainWindow):
    ...
    def visual3D(self):
        ...
        if extension.suffix == ".svg":
            ...
            for line in fichero:
                ...
                if comando.find('M3') != -1:
                    comando = comando.replace('M3','G00 Z0.00000')
                elif comando.find('M5') != -1:
                    comando = comando.replace('M5','G00 Z0.500000')
    ...
    def Z_UP(self):
        self.send_message('G00 Z0.500000')
        self.send_message('G90G21')

    def Z_DOWN(self):
        self.send_message('G00 Z0.00000')
        self.send_message('G90G21')
